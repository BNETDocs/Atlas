...
{
    class BanCommand : ChatCommand
    {
        public BanCommand(byte[] rawBuffer, List<string> arguments) : base(rawBuffer, arguments) { }
        ...
        public override void Invoke(ChatCommandContext context)
        {
            ...
            context.GameState.ActiveChannel.BanUser(context.GameState, targetState, string.Join(" ", Arguments));
        }
    }
}
