...
{
    class AdminDisconnectForFloodingCommand : ChatCommand
    {
        public AdminDisconnectForFloodingCommand(byte[] rawBuffer, List<string> arguments) : base(rawBuffer, arguments) { }
        ...
        public override void Invoke(ChatCommandContext context)
        {
            ...
            r = Resources.DisconnectedForFlooding;
            ...
            new SID_MESSAGEBOX().Invoke(new MessageContext(target.Client, MessageDirection.ServerToClient, new Dictionary<string, dynamic>(){
                { "style", (uint)0x10 }, { "caption", realmName }, { "text", r }
            }));
            new SID_FLOODDETECTED().Invoke(new MessageContext(target.Client, MessageDirection.ServerToClient));
