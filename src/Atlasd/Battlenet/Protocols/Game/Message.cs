    ...
    abstract class Message
    {
        ...
        public static Message FromByteArray(byte id, byte[] buffer)
        {
            return ((MessageIds)id) switch
            {
                ...
                MessageIds.SID_GAMERESULT => new Messages.SID_GAMERESULT(buffer),
                ...
                MessageIds.SID_WARCRAFTGENERAL => new Messages.SID_WARCRAFTGENERAL(buffer),
        ...
        public static string MessageName(byte messageId)
        {
            return (MessageIds)messageId switch
            {
                ...
                MessageIds.SID_WARCRAFTGENERAL => "SID_WARCRAFTGENERAL",
                ...
                MessageIds.SID_FRIENDSUPDATE => "SID_FRIENDSUPDATE",
