...
Namespace AtlasV.Battlenet.Protocols.Game.Messages
    Class SID_STARTADVEX3
        Inherits Message

        Public Enum Statuses As UInt32
            Success = 0
            GameNameExists = 1
            GameTypeUnavailable = 2
            [Error] = 3
            Error_Alt1 = 4
            Error_Alt2 = 5
        End Enum
        ...
        Public Sub New()
            Id = CByte(MessageIds.SID_STARTADVEX3)
        ...
        Public Overrides Function Invoke(ByVal context As MessageContext) As Boolean
            Select Case context.Direction
                Case MessageDirection.ClientToServer
                    ...
                    Dim gameState, gameElapsedTime, providerVersionConstant, ladderType As UInt32
                    ...
                    Using m = New MemoryStream(Buffer)
                        Using r = New BinaryReader(m)
                            ...
                            providerVersionConstant = r.ReadUInt32()
                            ladderType = r.ReadUInt32()
