...
Namespace AtlasV.Battlenet.Protocols.Game.ChatCommands
    Class DesignateCommand
        ...
        Public Overrides Sub Invoke(ByVal varContext As ChatCommandContext)
            ...
            If targetState.ActiveChannel <> varContext.GameState.ActiveChannel Then
                Call New ChatEvent(ChatEvent.EventIds.EID_ERROR, varContext.GameState.ChannelFlags, varContext.GameState.Ping, varContext.GameState.OnlineName, Resources.InvalidUser).WriteTo(varContext.GameState.Client)
                Return
            End If

            varContext.GameState.ActiveChannel.Designate(varContext.GameState, targetState)
            Call New ChatEvent(ChatEvent.EventIds.EID_INFO, varContext.GameState.ChannelFlags, varContext.GameState.Ping, varContext.GameState.OnlineName, Resources.DesignateCommand.Replace("{user}", targetState.OnlineName)).WriteTo(varContext.GameState.Client)
        End Sub
    End Class
End Namespace
