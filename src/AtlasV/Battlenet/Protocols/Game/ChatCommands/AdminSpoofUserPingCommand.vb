...
Namespace AtlasV.Battlenet.Protocols.Game.ChatCommands
    Class AdminSpoofUserPingCommand
        ...
        Public Overrides Sub Invoke(ByVal varContext As ChatCommandContext)
            ...
            Dim strPing = If(Arguments.Count = 0, "0", Arguments(0))
            Dim targetPing As Integer = Nothing

            If Not Daemon.Common.TryToInt32FromString(strPing, targetPing) Then
            ...
            If target.ActiveChannel IsNot Nothing Then
                target.ActiveChannel.UpdateUser(target, targetPing)
            Else
