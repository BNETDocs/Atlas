...
Namespace AtlasV.Battlenet.Exceptions
    Class ProtocolException
        ...
        Public Sub New(ByVal varProtocolType As ProtocolType.Types, ByVal varClient As ClientState)
            MyBase.New(varClient)
            ProtocolType = varProtocolType
        End Sub

        Public Sub New(ByVal varProtocolType As ProtocolType.Types, ByVal varClient As ClientState, ByVal varMessage As String)
